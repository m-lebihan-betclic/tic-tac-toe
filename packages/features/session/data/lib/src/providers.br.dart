...
import 'package:session_data/src/repositories/history_repository_single_source.dart';
...
@riverpod
HistoryRepository historyRepository(Ref ref) => HistoryRepositorySingleSource(
